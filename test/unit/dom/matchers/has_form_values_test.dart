...
main() {
  group('hasFormValues matcher', () {
    ...
    group('provides a useful failure message when provided with a valid name/value combination for a', () {
      Matcher getMatcherForExpectedCustomMatcherMessage({@required Map expected, @required Map actual}) {
        ...
        final actualFormValuesAsMatcherToStringValue = json.encode(actual).replaceAll(':', ': ').replaceAll(',', ', ');
        return allOf(
          contains(
