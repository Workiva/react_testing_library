(function (global, factory) {
            ...
            */
            ...
            function hover(element, init) {
              if (!(0, utils.hasPointerEvents)(element)) {
              ...
              if ((0, utils.isElementType)(select, 'select')) {
                if (select.multiple) {
                  for (const option of selectedOptions) {
                    const withPointerEvents = (0, utils.hasPointerEvents)(option); // events fired for multiple select are weird. Can't use hover...
                  ...
                  const withPointerEvents = (0, utils.hasPointerEvents)(select); // the click to open the select options
