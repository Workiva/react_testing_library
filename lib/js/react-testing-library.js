(function (global, factory) {
  ...
  */
  ...
  function arrayFrom$1(arrayLike, mapFn) {
    ...
    var A = isCallable$1(C) ? Object(new C(len)) : new Array(len); // 16. Let k be 0.
  ...
  var setGlobal = function (key, value) {
    try {
      defineProperty$c(global$1, key, { value: value, configurable: true, writable: true });
    } catch (error) {
      global$1[key] = value;
    } return value;
  };
  ...
  */
  ...
  // https://tc39.es/ecma262/#sec-object.defineproperty
  // eslint-disable-next-line es/no-object-defineproperty -- safe
  _export({ target: 'Object', stat: true, forced: Object.defineProperty !== defineProperty$b, sham: !descriptors }, {
  ...
  var defineProperty$a = defineProperty_1;
  ...
  defineProperty$9(exports, "__esModule", {
    value: true
  });
  ...
  var forEach$1 = function (it) {
    ...
    return it === ArrayPrototype$4 || (objectIsPrototypeOf(ArrayPrototype$4, it) && own === ArrayPrototype$4.forEach)
      || hasOwnProperty_1(DOMIterables$2, classof(it)) ? forEach$2 : own;
  };
  ...
  var entries$1 = function (it) {
    var own = it.entries;
    return it === ArrayPrototype$3 || (objectIsPrototypeOf(ArrayPrototype$3, it) && own === ArrayPrototype$3.entries)
      || hasOwnProperty_1(DOMIterables$1, classof(it)) ? entries$2 : own;
  };
  ...
  var concat$2 = function (it) {
    var own = it.concat;
    return it === ArrayPrototype$1 || (objectIsPrototypeOf(ArrayPrototype$1, it) && own === ArrayPrototype$1.concat) ? concat$3 : own;
  };
  ...
  var keys$1 = function (it) {
    var own = it.keys;
    return it === ArrayPrototype || (objectIsPrototypeOf(ArrayPrototype, it) && own === ArrayPrototype.keys)
      || hasOwnProperty_1(DOMIterables, classof(it)) ? keys$2 : own;
  };
  ...
  */
  ...
  var queryAllByTestId$1 = function queryAllByTestId() {
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
  ...
  var queryAllByTestIdWithSuggestions = wrapAllByQueryWithSuggestion(queryAllByTestId$1, queryAllByTestId$1.name, 'queryAll');

  var _buildQueries$7 = buildQueries(queryAllByTestId$1, getMultipleError, getMissingError),
      queryByTestId$1 = _buildQueries$7[0],
      getAllByTestId$1 = _buildQueries$7[1],
      getByTestId$1 = _buildQueries$7[2],
      findAllByTestId$1 = _buildQueries$7[3],
      findByTestId$1 = _buildQueries$7[4];
  ...
  */
  ...
  var screen$1 = typeof document !== 'undefined' && document.body ? getQueriesForElement(document.body, queries$1, initialValue) : Object.keys(queries$1).reduce(function (helpers, key) {
  ...
  */
  ...
  const globalObj = typeof window === 'undefined' ? commonjsGlobal : window; // Constant node.nodeType for text nodes, see:
  // https://developer.mozilla.org/en-US/docs/Web/API/Node/nodeType#Node_type_constants
  ...
  */
  ...
  var queryAllByTestIdOriginal = queries$1.queryAllByTestId,
      queryByTestIdOriginal = queries$1.queryByTestId,
      getAllByTestIdOriginal = queries$1.getAllByTestId,
      getByTestIdOriginal = queries$1.getByTestId,
      findAllByTestIdOriginal = queries$1.findAllByTestId,
      findByTestIdOriginal = queries$1.findByTestId,
      remainingQueries = _objectWithoutProperties(queries$1, ["queryAllByTestId", "queryByTestId", "getAllByTestId", "getByTestId", "findAllByTestId", "findByTestId"]);

  var queryAllByTestId = function queryAllByTestId(container, id, options) {
    console.log('custom queryAllByTestId');
    return [].concat(_toConsumableArray(queryHelpers.queryAllByAttribute('data-test-id', container !== null && container !== void 0 ? container : document.body, id, options)), _toConsumableArray(queryAllByTestIdOriginal(container !== null && container !== void 0 ? container : document.body, id, options)));
  };

  var _buildQueries = buildQueries(queryAllByTestId, function getMultipleError(container, dataTestId) {
    return "Found multiple elements with the data-mui-test attribute of: ".concat(dataTestId);
  }, function getMissingError(container, dataTestId) {
    return "Found no element with the data-mui-test attribute of: ".concat(dataTestId);
  }),
      _buildQueries2 = _slicedToArray(_buildQueries, 5),
      queryByTestIdNew = _buildQueries2[0],
      getAllByTestIdNew = _buildQueries2[1],
      getByTestIdNew = _buildQueries2[2],
      findAllByTestIdNew = _buildQueries2[3],
      findByTestIdNew = _buildQueries2[4];

  var queryByTestId = function queryByTestId(container, id, options) {
    var results = [queryByTestIdOriginal < T > (options), queryByTestIdNew(container, id)].filter(function (n) {
      return n;
    });
    return results.length > 1 ? results[0] : null;
  };

  var getAllByTestId = function getAllByTestId(container, id, options) {
    var results = [];
    var errors = [];

    try {
      results.push.apply(results, _toConsumableArray(getAllByTestIdOriginal < T > (container, id, options)));
    } catch (e) {
      errors.push(e);
    }

    try {
      results.push.apply(results, _toConsumableArray(getAllByTestIdNew(container, id)));
    } catch (e) {
      errors.push(e);
    }
  ...
  var getByTestId = function getByTestId(container, id, options) {
    var results = [];
    var errors = [];
  ...
  var findAllByTestId = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(container, id, options) {
      var results, errors;
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return Promise.any([findAllByTestIdOriginal(container, id, options), findAllByTestIdNew(container, id)]);
    ...
    return function findAllByTestId(_x, _x2, _x3) {
      return _ref.apply(this, arguments);
    };
  }();

  var findByTestId = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(container, id, options) {
      var results, errors;
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return findByTestIdOriginal(container, id, options);
            ...
            case 10:
              ...
              errors.push(_context2.t2);

            case 13:
              _context2.prev = 13;
              _context2.t3 = results;
              _context2.next = 17;
              return findByTestIdNew(container, id);
      ...
      }, _callee2, null, [[2, 10], [13, 21]]);
    }));

    return function findByTestId(_x4, _x5, _x6) {
      return _ref2.apply(this, arguments);
    };
  }();

  var queries = _objectSpread(_objectSpread({}, remainingQueries), {}, {
  ...
  function render(element, configuration) {
    return render$1(element, _objectSpread({
      queries: _objectSpread({}, queries)
    }, configuration));
  }

  var within = function within(element, queriesToBind) {
    return getQueriesForElement(element, _objectSpread(_objectSpread({}, queries), queriesToBind !== null && queriesToBind !== void 0 ? queriesToBind : {}));
  };

  var screen = within(document.body);
  ...
  exports.findAllByTestId = findAllByTestId$1;
  ...
  exports.findByTestId = findByTestId$1;
  ...
  exports.getAllByTestId = getAllByTestId$1;
  ...
  exports.getByTestId = getByTestId$1;
  ...
  exports.queryByTestId = queryByTestId$1;
