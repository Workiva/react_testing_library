(function (global, factory) {
  ...
  */
  ...
  var getTestIdAttribute$1 = function getTestIdAttribute() {
  ...
  var queryAllByTestId$1 = function queryAllByTestId() {
    ...
    return queryAllByAttribute.apply(void 0, [getTestIdAttribute$1()].concat(args));
  };

  var getMultipleError$8 = function getMultipleError(c, id) {
    return "Found multiple elements by: [" + getTestIdAttribute$1() + "=\"" + id + "\"]";
  };

  var getMissingError$7 = function getMissingError(c, id) {
    return "Unable to find an element by: [" + getTestIdAttribute$1() + "=\"" + id + "\"]";
  };

  var queryAllByTestIdWithSuggestions = wrapAllByQueryWithSuggestion(queryAllByTestId$1, queryAllByTestId$1.name, 'queryAll');

  var _buildQueries$7 = buildQueries(queryAllByTestId$1, getMultipleError$8, getMissingError$7),
  ...
  */
  ...
  var screen = typeof document !== 'undefined' && document.body ? getQueriesForElement(document.body, queries$1, initialValue) : Object.keys(queries$1).reduce(function (helpers, key) {
  ...
  */
  ...
  var overReactTestIdAttribute = "data-test-id";

  var areTestIdsEqual = function areTestIdsEqual() {
    return getTestIdAttribute() === overReactTestIdAttribute;
  };

  var getMultipleError = function getMultipleError(c, id) {
    return "Found multiple elements by: [".concat(getTestIdAttribute(), "=\"").concat(id, "\"]").concat(areTestIdsEqual() ? "" : ", [".concat(overReactTestIdAttribute, "=\"").concat(id, "\"]"));
  };

  var getMissingError = function getMissingError(c, id) {
    return "Unable to find an element by: [".concat(getTestIdAttribute(), "=\"").concat(id, "\"]").concat(areTestIdsEqual() ? "" : ", [".concat(overReactTestIdAttribute, "=\"").concat(id, "\"]"));
  };

  var testingLibraryQueryAllByTestId = queries$1.queryAllByTestId;

  var queryAllByTestId = function queryAllByTestId(container, id, options) {
    return [].concat(_toConsumableArray(areTestIdsEqual() ? [] : queryHelpers.queryAllByAttribute(overReactTestIdAttribute, container, id, options)), _toConsumableArray(testingLibraryQueryAllByTestId(container, id, options)));
  };
  ...
  var queries = _objectSpread$1(_objectSpread$1({}, queries$1), {}, {
  ...
  var within = function within(element, queriesToBind) {
    return (// @ts-ignore
      getQueriesForElement(element, _objectSpread$1(_objectSpread$1({}, queries), queriesToBind))
    );
  };
  exports.screen = within(document.body);
  ...
  */
  ...
  var render = function render(element, configuration) {
