(function (global, factory) {
            ...
            (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.rtl = {}, global.React, global.ReactDOM, global.ReactDOMClient));
})(this, (function (exports, k$1, l$1, ReactDOMClient) { 'use strict';
            ...
            var k__namespace = /*#__PURE__*/_interopNamespace(k$1);
             ...
             */
            function m$1(a){var b=a,c=a;if(a.alternate)for(;b.return;)b=b.return;else {a=b;do b=a,0!==(b.flags&4098)&&(c=b.return),a=b.return;while(a)}return 3===b.tag?c:null}function n$1(a){if(m$1(a)!==a)throw Error("Unable to find node on an unmounted component.");}
            function p$1(a){var b=a.alternate;if(!b){b=m$1(a);if(null===b)throw Error("Unable to find node on an unmounted component.");return b!==a?null:a}for(var c=a,d=b;;){var f=c.return;if(null===f)break;var g=f.alternate;if(null===g){d=f.return;if(null!==d){c=d;continue}break}if(f.child===g.child){for(g=f.child;g;){if(g===c)return n$1(f),a;if(g===d)return n$1(f),b;g=g.sibling;}throw Error("Unable to find node on an unmounted component.");}if(c.return!==d.return)c=f,d=g;else {for(var e=!1,h=f.child;h;){if(h===c){e=
            ...
            return c.stateNode.current===c?a:b}var q$1=Object.assign;function r$1(a){var b=a.keyCode;"charCode"in a?(a=a.charCode,0===a&&13===b&&(a=13)):a=b;10===a&&(a=13);return 32<=a||13===a?a:0}function t(){return !0}function u$1(){return !1}
            function v$1(a){function b(c,b,f,g,e){this._reactName=c;this._targetInst=f;this.type=b;this.nativeEvent=g;this.target=e;this.currentTarget=null;for(var d in a)a.hasOwnProperty(d)&&(c=a[d],this[d]=c?c(g):g[d]);this.isDefaultPrevented=(null!=g.defaultPrevented?g.defaultPrevented:!1===g.returnValue)?t:u$1;this.isPropagationStopped=u$1;return this}q$1(b.prototype,{preventDefault:function(){this.defaultPrevented=!0;var a=this.nativeEvent;a&&(a.preventDefault?a.preventDefault():"unknown"!==typeof a.returnValue&&
            (a.returnValue=!1),this.isDefaultPrevented=t);},stopPropagation:function(){var a=this.nativeEvent;a&&(a.stopPropagation?a.stopPropagation():"unknown"!==typeof a.cancelBubble&&(a.cancelBubble=!0),this.isPropagationStopped=t);},persist:function(){},isPersistent:t});return b}var w$1={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(a){return a.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},x$1=v$1(w$1),y$1=q$1({},w$1,{view:0,detail:0});v$1(y$1);
            var z$1,A$1,B$1,D$1=q$1({},y$1,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:C$1,button:0,buttons:0,relatedTarget:function(a){return void 0===a.relatedTarget?a.fromElement===a.srcElement?a.toElement:a.fromElement:a.relatedTarget},movementX:function(a){if("movementX"in a)return a.movementX;a!==B$1&&(B$1&&"mousemove"===a.type?(z$1=a.screenX-B$1.screenX,A$1=a.screenY-B$1.screenY):A$1=z$1=0,B$1=a);return z$1},movementY:function(a){return "movementY"in a?a.movementY:A$1}});
            v$1(D$1);var E$1=q$1({},D$1,{dataTransfer:0});v$1(E$1);var F$1=q$1({},y$1,{relatedTarget:0});v$1(F$1);var aa=q$1({},w$1,{animationName:0,elapsedTime:0,pseudoElement:0});v$1(aa);var ba=q$1({},w$1,{clipboardData:function(a){return "clipboardData"in a?a.clipboardData:window.clipboardData}});v$1(ba);var ca=q$1({},w$1,{data:0});v$1(ca);
            ...
            116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},fa={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"};function ha(a){var b=this.nativeEvent;return b.getModifierState?b.getModifierState(a):(a=fa[a])?!!b[a]:!1}function C$1(){return ha}
            var ia=q$1({},y$1,{key:function(a){if(a.key){var b=da[a.key]||a.key;if("Unidentified"!==b)return b}return "keypress"===a.type?(a=r$1(a),13===a?"Enter":String.fromCharCode(a)):"keydown"===a.type||"keyup"===a.type?ea[a.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:C$1,charCode:function(a){return "keypress"===a.type?r$1(a):0},keyCode:function(a){return "keydown"===a.type||"keyup"===a.type?a.keyCode:0},which:function(a){return "keypress"===
            a.type?r$1(a):"keydown"===a.type||"keyup"===a.type?a.keyCode:0}});v$1(ia);var ja=q$1({},D$1,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0});v$1(ja);var ka=q$1({},y$1,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:C$1});v$1(ka);var la=q$1({},w$1,{propertyName:0,elapsedTime:0,pseudoElement:0});v$1(la);
            var ma=q$1({},D$1,{deltaX:function(a){return "deltaX"in a?a.deltaX:"wheelDeltaX"in a?-a.wheelDeltaX:0},deltaY:function(a){return "deltaY"in a?a.deltaY:"wheelDeltaY"in a?-a.wheelDeltaY:"wheelDelta"in a?-a.wheelDelta:0},deltaZ:0,deltaMode:0});v$1(ma);function na(a,b,c,d,f,g,e,h,N){var G=Array.prototype.slice.call(arguments,3);try{b.apply(c,G);}catch(oa){this.onError(oa);}}var H$1=!1,I$1=null,J=!1,K=null,pa={onError:function(a){H$1=!0;I$1=a;}};function qa(a,b,c,d,f,g,e,h,N){H$1=!1;I$1=null;na.apply(pa,arguments);}
            function ra(a,b,c,d,f,g,e,h,N){qa.apply(this,arguments);if(H$1){if(H$1){var G=I$1;H$1=!1;I$1=null;}else throw Error("clearCaughtError was called but no error was captured. This error is likely caused by a bug in React. Please file an issue.");J||(J=!0,K=G);}}var L=Array.isArray,M=l__default["default"].__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events,sa=M[0],ta=M[1],ua=M[2],va=M[3],wa=M[4],xa=k__default["default"].unstable_act;function ya(){}
            function za(a,b){if(!a)return [];a=p$1(a);if(!a)return [];for(var c=a,d=[];;){if(5===c.tag||6===c.tag||1===c.tag||0===c.tag){var f=c.stateNode;b(f)&&d.push(f);}if(c.child)c.child.return=c,c=c.child;else {if(c===a)return d;for(;!c.sibling;){if(!c.return||c.return===a)return d;c=c.return;}c.sibling.return=c.return;c=c.sibling;}}}
            ...
            var Simulate=Z;var act$1=xa;var findAllInRenderedTree=S;var findRenderedComponentWithType=function(a,b){O(a,"findRenderedComponentWithType");a=V(a,b);if(1!==a.length)throw Error("Did not find exactly one match (found: "+a.length+") for componentType:"+b);return a[0]};var findRenderedDOMComponentWithClass=function(a,b){O(a,"findRenderedDOMComponentWithClass");a=T(a,b);if(1!==a.length)throw Error("Did not find exactly one match (found: "+a.length+") for class:"+b);return a[0]};
            var findRenderedDOMComponentWithTag=function(a,b){O(a,"findRenderedDOMComponentWithTag");a=U(a,b);if(1!==a.length)throw Error("Did not find exactly one match (found: "+a.length+") for tag:"+b);return a[0]};var isCompositeComponent=Q;var isCompositeComponentWithType=R;var isDOMComponent=P;var isDOMComponentElement=function(a){return !!(a&&k__default["default"].isValidElement(a)&&a.tagName)};var isElement$2=function(a){return k__default["default"].isValidElement(a)};
            var isElementOfType=function(a,b){return k__default["default"].isValidElement(a)&&a.type===b};var mockComponent=function(a,b){b=b||a.mockTagName||"div";a.prototype.render.mockImplementation(function(){return k__default["default"].createElement(b,null,this.props.children)});return this};var nativeTouchData=function(a,b){return {touches:[{pageX:a,pageY:b}]}};var renderIntoDocument=function(a){var b=document.createElement("div");return l__default["default"].render(a,b)};var scryRenderedComponentsWithType=V;
            var scryRenderedDOMComponentsWithClass=T;var scryRenderedDOMComponentsWithTag=U;var traverseTwoPhase=X;
            ...
            var reactDomTestUtils_production_min = {
            	...
            	nativeTouchData: nativeTouchData,
            ...
            var React = k__default["default"];
            var ReactDOM = l__default["default"];
            ...
            */
            ...
            function createConcurrentRoot(container, _ref) {
              ...
              if (_hydrate) {
                act(function () {
                  root = ReactDOMClient__namespace.hydrateRoot(container, WrapperComponent ? /*#__PURE__*/k__namespace.createElement(WrapperComponent, null, ui) : ui);
                });
              } else {
            ...
            function createLegacyRoot(container) {
              return {
                hydrate: function hydrate(element) {
                  l__default["default"].hydrate(element, container);
                },
                render: function render(element) {
                  l__default["default"].render(element, container);
                },
                unmount: function unmount() {
                  l__default["default"].unmountComponentAtNode(container);
                }
              };
            }
            ...
            function renderRoot(ui, _ref2) {
              ...
              var wrapUiIfNeeded = function wrapUiIfNeeded(innerElement) {
                return WrapperComponent ? /*#__PURE__*/k__namespace.createElement(WrapperComponent, null, innerElement) : innerElement;
              };
